  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] w-ful"> Payment Method.</h1>
      ...
      <div className={`${styles.flexCenter} flex flex-1 md:my-0 my-10 relative`}>
        ...
        <div className="absolute z-[0] bottom-20 right-20 w-[50%] h-[50%] blue__gradient rounded-full" />
      </div> 
